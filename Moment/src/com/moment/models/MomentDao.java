...
*/
public class MomentDao extends AbstractDao<Moment, Integer> {
    ...
    */
    public static class Properties {
        ...
        public final static Property UserId = new Property(17, int.class, "userId", false, "USER_ID");
        public final static Property MomentId = new Property(18, int.class, "momentId", false, "MOMENT_ID");
    };

    private DaoSession daoSession;

    private Query<Moment> user_MomentListQuery;
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'moments' (" + //
                ...
                "'MOMENT_ID' INTEGER NOT NULL );"); // 18: momentId
        // Add Indexes
    ...
    public Moment readEntity(Cursor cursor, int offset) {
        Moment entity = new Moment( //
            ...
            cursor.getInt(offset + 17) // userId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Moment entity, int offset) {
        ...
        entity.setUserId(cursor.getInt(offset + 17));
     }
    
    /** @inheritdoc */
    @Override
    protected Integer updateKeyAfterInsert(Moment entity, long rowId) {
        return entity.getId();
    }
    
    /** @inheritdoc */
    @Override
    public Integer getKey(Moment entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    /** Internal query to resolve the "momentList" to-many relationship of User. */
    public List<Moment> _queryUser_MomentList(int momentId) {
        synchronized (this) {
            if (user_MomentListQuery == null) {
                QueryBuilder<Moment> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.MomentId.eq(null));
                user_MomentListQuery = queryBuilder.build();
            }
        }
        Query<Moment> query = user_MomentListQuery.forCurrentThread();
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(" LEFT JOIN users T0 ON T.'USER_ID'=T0.'ID'");
            builder.append(' ');
