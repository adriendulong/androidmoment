...
public class User {
    ...
    public User(Integer id, Integer facebookId, Integer nbFollows, Integer nbFollowers, String email, String secondEmail, String firstName, String lastName, String pictureProfileUrl, String keyBitmap, String numTel, String secondNumTel, String fbPhotoUrl, String idCarnetAdresse, String description, Boolean isSelect, int momentId) {
        this.id = id;
    ...
    public Moment getMoment(int momentId){
        return this.momentList.get(momentId);
    }
