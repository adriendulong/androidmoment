...
public class Moment implements Parcelable {
	...
	public void setMomentFromJson(JSONObject moment) throws JSONException{
		...
		//Invites
		this.guestsNumber = moment.getInt("guestsNumber");
		this.guestsComing = moment.getInt("guestsComing");
		this.guestsNotComing = moment.getInt("guestsNotComing");
		...
		if (moment.has("user")){
			JSONObject owner = moment.getJSONObject("user");
			this.user = new User();
     ...
     * //TODO: Prendre en charge de pas envoyer la date si y en a pas (Boolean journee entiere ou pas)
	 */
	...
	public void printCover(final ImageView targetView, final Boolean isRounded){
		...
		System.out.println("Print cover at address : "+ urlCover);
	...
	public Moment(Parcel in){
		...
		this.placeInformations = in.readString();
	...
	public void writeToParcel(Parcel out, int flags) {
		...
		out.writeString(placeInformations);
