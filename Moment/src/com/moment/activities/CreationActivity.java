...
public class CreationActivity extends SherlockActivity {
     ...
     * On recupere alors les �v�nements FB que l'utilisateurs a cr��
     * @param view
     */
   ...
   /**
    * Class utilise lorsque l'utilisateur se connecte � Facebook
    * @author adriendulong
    *
    */
		...
		public void onComplete(String response, Object state) {
    		try {
    			...
    			CreationActivity.this.runOnUiThread(new Runnable() {
    				@Override
					public void run() {
    					//Creer et demarrer l'activit� de choix des evenemts
    ...
    /**
     * L'utilisateur valide le nom du moment qu'il a cr��
     * Si un nom est bien rentr� on passe � la cr�ation du moment
     * @param view
     */
    ...
    public void valideNom(View view) {
        ...
        //On verifie qu'un nom a �t� rentr�
        if(!nomMoment.getText().toString().matches("")){
        	...
        	//Creer et demarrer l'activit� de cr�ation d'un moment
    	    Intent intent = new Intent(CreationActivity.this, CreationDetailsActivity.class);
    	    intent.putExtras(bundle);
    	    startActivity(intent);
        }
        else{
        	//On previent l'utilisateur qu'il doit rentrer un nom afin de continuer la cr�ation
