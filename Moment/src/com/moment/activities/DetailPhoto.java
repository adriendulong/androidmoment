...
public class DetailPhoto extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(this).load(photo.getUrlOriginal()).placeholder(R.drawable.photo_photo).fit().into(imageView);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                position++;
                photo = AppMoment.getInstance().user.getMomentById(momentID).getPhotos().get(position);
                Picasso.with(getApplicationContext()).load(photo.getUrlOriginal()).placeholder(R.drawable.photo_photo).fit().into(imageView);
