...
public class UserDao extends AbstractDao<User, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property MomentId = new Property(16, long.class, "momentId", false, "MOMENT_ID");
        public final static Property PhotoId = new Property(17, long.class, "photoId", false, "PHOTO_ID");
        public final static Property ChatId = new Property(18, long.class, "chatId", false, "CHAT_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'users' (" + //
                ...
                "'PHOTO_ID' INTEGER NOT NULL ," + // 17: photoId
                "'CHAT_ID' INTEGER NOT NULL );"); // 18: chatId
        // Add Indexes
    ...
    protected void bindValues(SQLiteStatement stmt, User entity) {
        ...
        stmt.bindLong(18, entity.getPhotoId());
        stmt.bindLong(19, entity.getChatId());
    }
    ...
    public User readEntity(Cursor cursor, int offset) {
        User entity = new User( //
            ...
            cursor.getLong(offset + 16), // momentId
            cursor.getLong(offset + 17), // photoId
            cursor.getLong(offset + 18) // chatId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, User entity, int offset) {
        ...
        entity.setMomentId(cursor.getLong(offset + 16));
        entity.setPhotoId(cursor.getLong(offset + 17));
        entity.setChatId(cursor.getLong(offset + 18));
     }
