...
public class PhotoDao extends AbstractDao<Photo, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property PhotoId = new Property(5, long.class, "photoId", false, "PHOTO_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'photos' (" + //
                ...
                "'PHOTO_ID' INTEGER NOT NULL );"); // 5: photoId
        // Add Indexes
    ...
    public List<Photo> _queryUser_PhotoList(long photoId) {
        synchronized (this) {
